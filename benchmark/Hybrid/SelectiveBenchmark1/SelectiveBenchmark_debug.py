...
from benchmark.Hybrid2.SelectiveBenchmark1.SelectiveHyper import get_hyperparameters, n_jobs
from benchmark.Hybrid2.HybridReaders import read_adult, read_german_credit, read_fico, read_compass, read_home, small_datasets, read_wine
...
def main():
    ...
    for dataset_fun in (small_datasets + [
        read_home,
        read_wine,
        read_german_credit,
        read_compass,
        ...
        for dataset_name, df in datasets.items():
            ...
            if single_t:
                for model, hyper_dict, hyper_stump_dict in tqdm(list(get_hyperparameters(df)),
                    ...
                    processes.append(run(model, hyper_dict, hyper_stump_dict, dataset_name+"_debug", df))
