...
class RuleTreeRegressor(RuleTree):
    def __init__(self,
                 impurity_measure: str = "squared_error",
    ...
    def fit(self, X, y=None):
        ...
        if self.verbose:
            print(datetime.datetime.now(), 'Model type: %s.', MODEL_TYPE_REG)
    ...
    def calculate_task_medoids(node_dict, X, y, Xr):
        ...
        for node_id in node_dict:
            ...
            median_y = np.median(y[node.idx])
            diff_with_median_y = y[node.idx] - median_y
